...
function startServer(app) {
    return new Promise((resolve, reject) => {
        ...
        const server = app.listen(port, () => {
            ...
            console.log(`${colors.cyan}${colors.bold}    ███████╗╚██████╗██║  ██║███████╗███████╗╚██████╔╝██║ ╚████║${colors.reset}`);
            console.log(`${colors.cyan}${colors.bold}    ╚══════╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚══════╝ ╚═════╝ ╚═╝  ╚═══╝${colors.reset}`);
            console.log(`${colors.gray}           Roblox Group Ranking API v1.2.0${colors.reset}`);
            console.log('');
            console.log(`${colors.green}${colors.bold}══════════════════════════════════════════════════════════════${colors.reset}`);
            console.log(`${colors.green}${colors.bold}                    SERVER ONLINE${colors.reset}`);
            console.log(`${colors.green}${colors.bold}══════════════════════════════════════════════════════════════${colors.reset}`);
            console.log('');
            console.log(`${colors.cyan}  Port:${colors.reset}      ${port}`);
            console.log(`${colors.cyan}  URL:${colors.reset}       http://localhost:${port}`);
            console.log(`${colors.cyan}  Rate:${colors.reset}      ${config.rateLimit.max} req/15min`);
            console.log('');
            console.log(`${colors.magenta}${colors.bold}  Endpoints:${colors.reset}`);
            console.log(`${colors.blue}    GET  /health${colors.reset}              Health check`);
            console.log(`${colors.blue}    GET  /session${colors.reset}             Session status`);
            console.log(`${colors.blue}    GET  /api/rank/:userId${colors.reset}    Get user rank`);
            console.log(`${colors.blue}    POST /api/rank${colors.reset}            Set rank`);
            ...
            console.log('');
            console.log(`${colors.green}${colors.bold}  Ready to manage your hierarchy.${colors.reset}`);
            console.log('');
